<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Dashboard.Master" AutoEventWireup="true" CodeBehind="Sua.aspx.cs" Inherits="MyWeb.Admin.QLSP.Sua" %>
                ...
                <div class="col-12 col-md d-flex">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!-- Ảnh sản phẩm -->
                            <div class="mb-3">
                                <label for="productImage" class="form-label">Chọn ảnh sản phẩm (nếu muốn thay đổi):</label>
                            ...
                            <!-- Nút cập nhật -->
                            <asp:Button ID="btnUpdateProduct" runat="server" Text="Cập nhật sản phẩm" CssClass="btn btn-primary" OnClick="UpdateProduct" />
